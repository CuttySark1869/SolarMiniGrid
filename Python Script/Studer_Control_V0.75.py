...
BSP Version: 1.6.14
Script Version: 0.75
Update Note: Compared with V0.65, V0.7 adds multiple ports choices so that
             more than one Xtender system can be connected to the same PC.
"""
# ------------------------------------------------------------------------
# 1. Import packages
import serial
...
def xtender_open(port_index, Xtender_open):
    if Xtender_open:
        # Xtender on
        r1415.write(port_index, 1)


def xtender_close(port_index, Xtender_close):
    if Xtender_close:
        # Xtender off
        r1399.write(port_index, 0)
