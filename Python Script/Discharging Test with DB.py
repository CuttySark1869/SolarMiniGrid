...
def data_collection(port_index):
  ...
  table_name = 'Unit' + str(port_index) + '_Discharging'
  DB_name = DB_dir + 'StuderOperation.db'
...
#     sample_no = 4
  ...
  system_init(6)
  xtender_open(6, Xtender_open)
  rcc_time_sync(6, rcc_init)
  bsp_init(6, bsp_init, battery_setting)
